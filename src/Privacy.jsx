        ...
        <strong>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="subtitle">
              Last updated <bdt className="question">August 26, 2022</bdt>
            </span>
          </span>
        </strong>
      </span>
    ...
    <div style={{ lineHeight: "1.5" }}>
      <span style={{ color: "rgb(127, 127, 127)" }}>
        <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
          <span data-custom-class="body_text">
            ...
            <bdt className="question">Rad Soft, Inc.</bdt>
        ...
        <span style={{ fontSize: 15 }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span data-custom-class="body_text">
              ...
              <bdt className="question">geeth.gunnampalli@radsoftinc.com</bdt>.
            </span>
          </span>
        </span>
      </div>
      ...
      <div style={{ lineHeight: "1.5" }}>
        ...
        <a
          ...
          href="https://app.termly.io/notify/615c1621-3b06-483f-a4cb-5ec1e27d1013"
                                                                                ...
                                                                                <span data-custom-class="body_text">
                                                                                  ...
                                                                                  >
                                                                                    <span data-custom-class="body_text">
                                                                                      ...
                                                                                      at{" "}
                                                                                      <bdt className="question">
                                                                                        geeth.gunnampalli@radsoftinc.com
                                                                                      </bdt>
                                                                                      <bdt className="statement-end-if-in-editor" />
                                                                                    </span>
                                                                                  </span>
